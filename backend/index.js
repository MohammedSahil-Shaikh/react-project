...
// app.get('/getAllRestaurantCards', (req, res) => {
...
//         }
//     }
//     res.status(200).json(restaurantCards);
// });

app.get('/getAllRestaurantCards', async (req, res) => {

    try {
        const restaurants = await Restaurant.find();
        res.status(200).json(restaurants);
    } catch (error) {
        console.log('Error retrieving restaurants data: ', error);
        res.status(500).json({
...
app.get('/getRestaurantMenu', async (req, res) => {
    
    try {
        const { restaurantId } = req.query;
        const menu = await Menu.findOne({id: restaurantId});
